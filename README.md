...
| \*\*Random Forest (`class\_weight='balanced'`)\*\* ✅ | 78.9% | 59.2% | \*\*65.4%\*\* | 62.2% |
...
the EDA findings: `Contract\_Two year` and `InternetService\_Fiber optic` emerged as the two
...
&#x20; <img src="outputs/churn\_by\_contract.png" width="420">

&#x20; <img src="outputs/churn\_by\_tenure.png" width="420">

</p>

<p align="center">

&#x20; <img src="outputs/risk\_segment\_scatter.png" width="420">

&#x20; <img src="outputs/feature\_importance.png" width="420">
...
│   ├── WA\_Fn-UseC\_-Telco-Customer-Churn.csv      # Raw dataset

│   └── telco\_churn\_with\_segments.csv             # Cleaned dataset with risk segments (Power BI source)
